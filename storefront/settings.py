...
SECRET_KEY = 'django-insecure-mv^wj_d%mf@^&91)6#y)(qp#)7o7mae%9zmhyta@^u&+n#8!nm'
...
INSTALLED_APPS = [
    ...
    'django.contrib.sessions',  # Deprecated
...
REST_FRAMEWORK = {
    ...
    # 'PAGE_SIZE': 10 # since we are using custom pagination class
}
